...
<div class='information-box'>
 <h2>Tracker Set Up Utility</h2>
 <p style='font-size:12px'>
 	<br />
 	<strong>Welcome to the Tracker Module set up utility.</strong>
	<br />
...
<div class='information-box'>
 ...
 <p style='font-size:12px'>
	...
	{$lang}
	<br /><br />
	<a href='{$this->settings['base_url']}app=tracker&amp;module=modules'><b>{$this->lang->words['return_to_overview']}</b></a>
 </p>
</div>
...
$IPBHTML .= <<<EOF
<form action="{$this->settings['base_url']}&amp;{$this->form_code}&amp;do=sql&amp;directory={$data['directory']}&amp;type={$type}&amp;version={$data['next_version']}" method='post'>
	<div class='acp-box'>
		<h3>{$prefix} {$data['title']} Module</h3>
