...
$_PERM_CONFIG[] = 'PrivacyFieldPrivacyProject';

class trackerPermMappingPrivacyFieldPrivacyProject extends tracker_extension_perms_base
{
	/**
	...
	protected $permNames = array(
		'show'     => 'See ALL Private Issues',
		'submit'   => 'Submit Private Issues',
		'update'   => 'Update Privacy Status'
	);
