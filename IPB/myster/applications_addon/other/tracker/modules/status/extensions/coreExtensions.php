...
$_PERM_CONFIG[] = 'StatusFieldStatusProject';

class trackerPermMappingStatusFieldStatusProject extends tracker_extension_perms_base
{
	/**
	...
	protected $permNames = array(
		'show'     => 'Show Status Field',
		'submit'   => 'Set in New Issue',
		'update'   => 'Change in a Reply',
		'allowall' => 'Access to All Statuses'
	);
