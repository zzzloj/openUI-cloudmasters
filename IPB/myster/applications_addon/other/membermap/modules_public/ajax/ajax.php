...
class public_membermap_ajax_ajax extends ipsAjaxCommand
{
    ...
    public function doAdd()
    {
        ...
        {
            $this->returnJsonArray(array('error' => TRUE, 'message' => 'You do not have permission to add your location.'));
        }
    }
    ...
    public function doUpdate()
    {
        ...
        {
            $this->returnJsonArray(array('error' => TRUE, 'message' => 'You do not have permission to update your location.'));
        }
    }
