...
class admin_gsidebars_settings_settings extends ipsCommand
{
	public $html;
	...
	public function doExecute( ipsRegistry $registry )
	{
		...
		$this->registry->output->html .= $this->registry->gsLibrary->c_acp();
	...
	{			
		...
		$this->request['conf_title_keyword'] = 'dp3_gsidebars';
