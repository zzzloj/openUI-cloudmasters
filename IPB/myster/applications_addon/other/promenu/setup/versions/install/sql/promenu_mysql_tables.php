...
$TABLE[] = "CREATE TABLE promenuplus_groups (
  ...
  promenu_groups_make_super tinyint(1) NOT NULL DEFAULT  '0',
  promenu_groups_promore tinyint(1) NOT NULL DEFAULT '0',
  promenu_groups_add_other tinyint(1) NOT NULL DEFAULT '0',
  promenu_groups_allow_docking tinyint(1) NOT NULL DEFAULT '0',
  promenu_groups_default_mobile INT( 10 ) NOT NULL DEFAULT  '3',
  promenu_groups_default_position INT( 10 ) NOT NULL DEFAULT  '2',
  promenu_groups_min_width INT( 25 ) NOT NULL DEFAULT  '1000',
...
$TABLE[] = "CREATE TABLE promenuplus_menus (
  ...
  promenu_menus_wrapper text,
  promenu_menus_wrapper_height int(10) NOT NULL DEFAULT '0',
  promenu_menus_wrapper_wrapped tinyint(1) NOT NULL DEFAULT '0',
  promenu_menus_more_disable tinyint(1) NOT NULL DEFAULT '0',
  promenu_menus_disable_wrapper_menu tinyint(1) NOT NULL DEFAULT '0',
