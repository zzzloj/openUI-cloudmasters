...
foreach( ipsRegistry::$applications as $app_dir => $application )
{
	...
	<div id='tab_{$application['app_id']}_content'>
		<table class='ipsTable double_pad'>
			<tr>
				<th colspan='2'><label for='app_{$application['app_id']}'>{$form} {$this->lang->words['r_grantto']} {$this->lang->words['application_bit']}  {$application['app_title']}?</label></th>
			</tr>
		</table>
HTML;
		...
		foreach( ipsRegistry::$modules[ $app_dir ] as $module )
		{
			...
			<table class='ipsTable double_pad'>
			<tr>
				<th colspan='2'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label for='module_{$module['sys_module_id']}'>{$form} {$this->lang->words['r_grantto']} {$this->lang->words['module_bit']} {$module['sys_module_title']}?</label></th>
			</tr>
			</table>
