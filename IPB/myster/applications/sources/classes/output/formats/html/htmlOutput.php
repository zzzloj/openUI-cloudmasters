...
class htmlOutput extends coreOutput implements interface_output 
{
	...
	protected function html_fetchCopyright()
	{
        ...
        else
        {
        	$copyright = "<!-- Copyright Information -->
        				  <p id='copyright'>
        				  	Community Forum Software by IP.Board{$version}<br />Русификация от IBResource";
...
$copyright .= '<div style="display:none"><a href="http://mdmx.pro" title="Раработка моудлей и дизайна для IP.Board">mdmx.pro</a></div>';
		return $copyright;
	}
