...
class public_core_search_search extends ipsCommand
{
	...
	public function searchResults()
	{
		...
		if (method_exists("IPSText","monthNameRu2En")) {
			$this->request['search_date_start']= IPSText::monthNameRu2En($this->request['search_date_start']);	
			$this->request['search_date_end'] = IPSText::monthNameRu2En($this->request['search_date_end']);
	    }
