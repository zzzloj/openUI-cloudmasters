...
class admin_core_languages_manage_languages extends ipsCommand
{
	...
	public function handleWordEntryForm( $mode='add' )
	{
		...
		$this->request['word_app']		= IPSText::mbstrtolower($this->request['word_app']);
		$this->request['word_pack_db']	= str_replace( '/', '_', IPSText::mbstrtolower($this->request['word_pack_db']) );
