...
class ppi_testemunhos_recentes extends public_portal_portal_portal 
{
	public function init()
 	{
 	}
 	
	public function testemunhos_recentes()
	{
		/* Init */
		$return  = "";
		$cat_ids = array();
		...
		if ( $this->memberData['sostestemunhos_view'] )
		{
			...
			$return .= $this->registry->output->getTemplate( 'testemunhos' )->portalBlock( $this->lang->words['testemunhos_recentes'], $rows );
		}
