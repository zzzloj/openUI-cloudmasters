...
/**
 * Main Status field class
 *
 * @package Tracker
 * @subpackage Module-Status
 * @since 2.0.0
 */
class tracker_module_status
{
	/**
	 * Constructor - initialize any necessary code or data for the module here
	 *
	...
	public function loadFieldClass( $field )
	{
