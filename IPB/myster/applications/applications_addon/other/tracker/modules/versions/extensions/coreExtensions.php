...
$_PERM_CONFIG[] = 'VersionsFieldVersionProject';
$_PERM_CONFIG[] = 'VersionsFieldFixed_inProject';

class trackerPermMappingVersionsFieldVersionProject extends tracker_extension_perms_base
{
	/**
	...
	protected $permNames = array(
		'show'      => 'Show Versions Field',
		'submit'    => 'Set in New Issue',
		'update'    => 'Change in a Reply',
		'developer' => 'Access to Staff Versions',
		'alter'		=> 'Can Alter Versions'
	);
...
class trackerPermMappingVersionsFieldFixed_inProject extends tracker_extension_perms_base
{
	/**
	 * Mapping of keys to columns
	 *
	 ...
	 */
	protected $permNames = array(
		'show'      => 'Show Fixed In Field',
		'submit'    => 'Set in New Issue',
		'update'    => 'Change in a Reply',
		'developer' => 'Access to Staff Versions',
		'report'    => "Generate 'Fixed In' Reports"
	);
