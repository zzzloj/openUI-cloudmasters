...
$knownSettings = array( 
	 'tracker_upload_dir'		=> IPSSetUp::getSavedData('install_dir') ? IPSSetUp::getSavedData('install_dir') . '/uploads' : ipsRegistry::$settings['upload_dir'],
	 'tracker_upload_url'		=> IPSSetUp::getSavedData('install_url') ? IPSSetUp::getSavedData('install_url') . '/uploads' : ipsRegistry::$settings['upload_url'],
);