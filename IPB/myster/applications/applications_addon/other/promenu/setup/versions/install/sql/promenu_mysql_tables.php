 ...
 */
$TABLE[] = "CREATE TABLE promenuplus_groups (
  ...
  promenu_groups_by_url tinyint(1) NOT NULL DEFAULT '1',
  promenu_groups_is_vertical tinyint(1) NOT NULL DEFAULT '0',
  promenu_groups_border tinyint(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (promenu_groups_id)
);";

$TABLE[] = "CREATE TABLE promenuplus_menus (
  promenu_menus_id int(255) NOT NULL AUTO_INCREMENT,
  promenu_menus_by_url tinyint(1) NOT NULL DEFAULT '1',
