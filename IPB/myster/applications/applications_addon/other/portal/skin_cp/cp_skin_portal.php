...
$IPBHTML .= <<<EOF
		<tr>
			<td class='no_messages'>
                {$this->lang->words['no_plugins_warning']} <a href='{$this->settings['base_url']}&amp;module=blocks&amp;section=blocks&amp;do=block_add' class='mini_button'>{$this->lang->words['add_block']}</a>				
			</td>
		</tr>
