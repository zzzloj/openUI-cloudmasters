    	...
    	elseif($data['field_type'] == 'radiobutton')
    	{
            ...
            if( is_array( $data['field_options'] ) )
            {
        		...
        		{		  
        			...
        			$html_data .= $value == $data['field_value'] ? " checked='checked' /> <label for='{$value}'>{$value}</label><br />" : " /> <label for='{$value}'>{$value}</label><br />";
        		}                
            }
    	}
    	...
    	elseif($data['field_type'] == 'checkbox')
    	{
            ...
            if( is_array( $data['field_options'] ) )
            {
        		...
        		{	  
        			...
        			$html_data .= in_array($value, $value_array) ? " checked='checked' /> <label for='{$value}'>{$value}</label><br />" : " /> <label for='{$value}'>{$value}</label><br />";
        		}                
            }
        }
