<?php
/**
 * @file		plugin_galleryimages.php 	IP.Gallery unapproved images modcp plugin
 *~TERABYTE_DOC_READY~
...
class plugin_gallery_galleryimages
{
	...
	public function executePlugin( $permissions )
	{
		...
		$this->DB->build( array(
								...
								'where'		=> "i.image_approved=0" . $limiter,
								'add_join'	=> array(
													array(
		...
		return $this->registry->getClass('output')->getTemplate('gallery_external')->unapprovedImages( $results );
	}
