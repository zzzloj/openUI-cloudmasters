<?php
/**
 * @file		cp_skin_tools.php 	IP.Downloads Tools skin file
 *~TERABYTE_DOC_READY~
 ...
 *
 * @class		cp_skin_tools
 * @brief		IP.Downloads Tools skin file
 */
class cp_skin_tools
{
	/**
...
<tr class='ipsControlRow'>
	...
	<td><a href='{$this->settings['board_url']}/index.php?app=downloads&amp;showfile={$file['file_id']}'>{$file['file_name']}</a></td>
	<td class='col_buttons'>
		<ul class='ipsControlStrip'>
			<li class='i_edit'><a href='{$this->settings['board_url']}/index.php?app=downloads&amp;module=post&amp;section=submit&amp;do=edit_main&amp;id={$file['file_id']}' target='_blank' title='{$this->lang->words['d_editfile']}'>{$this->lang->words['d_editfile']}</a></li>
		</ul>
	</td>
</tr>
EOF;
