<?php
/**
 * @file		plugin_unapprovedfiles.php 	Moderator control panel plugin: show IDM files pending approval
 *~TERABYTE_DOC_READY~
...
/**
 *
 * @class		plugin_downloads_unapprovedfiles
 * @brief		Moderator control panel plugin: show IDM files pending approval
 */
class plugin_downloads_unapprovedfiles
{
	/**
	...
	public function executePlugin( $permissions )
	{
		...
		return $this->registry->getClass('output')->getTemplate('downloads_other')->moderatorPanel( 'unapproved', $results );
	}
