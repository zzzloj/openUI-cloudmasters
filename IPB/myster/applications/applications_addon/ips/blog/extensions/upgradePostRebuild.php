...
/**#@+
	...
	public function getRawPost( $type, $r )
	{
		...
		{
			case 'blog_entries':
				$this->parser->parse_html		= $r['entry_html_state'] ? 1 : 0;
				$this->parser->parse_nl2br		= $r['entry_html_state'] == 2 ? 1 : 0;
				$this->parser->parse_nl2br		= $r['entry_use_emo'] ? 1 : 0;
				$this->parser->parsing_section	= 'blog_entry';

				$rawpost = $this->parser->preEditParse( $r['entry'] );
			break;
			
			case 'blog_comments':
				$this->parser->parse_html		= $r['comment_html_state'] ? 1 : 0;
				$this->parser->parse_nl2br		= $r['comment_html_state'] == 2 ? 1 : 0;
				$this->parser->parse_nl2br		= $r['comment_use_emo'] ? 1 : 0;
			...
			case 'blog_cblocks':
				$this->parser->parse_html		= $r['cbcus_html_state'] ? 1 : 0;
				$this->parser->parse_nl2br		= $r['cbcus_html_state'] == 2 ? 1 : 0;
				
				$this->parser->parsing_section	= 'blog_cblock';

				$rawpost = $this->parser->preEditParse( $r['cbcus'] );
			break;
		}
