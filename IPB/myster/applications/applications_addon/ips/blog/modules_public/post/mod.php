 ...
 * IP.Board v2.6.3
 * Moderator Stuff
 * Last Updated: $LastChangedDate: 2013-04-22 20:57:11 -0400 (Mon, 22 Apr 2013) $
 * </pre>
 *
...
class public_blog_post_mod extends ipsCommand
{
	...
	public function deleteEntry()
	{
		...
		/* Check if we got access (and not just trying some id's :P) */
		if( empty( $entry ) or $entry['entry_id'] == "" )
		{
	...
	public function doMMod()
	{
		...
		/* IDs */
		$selectedids = IPSLib::cleanIntArray( explode( ',', $this->request['selectedbids'] ) );
