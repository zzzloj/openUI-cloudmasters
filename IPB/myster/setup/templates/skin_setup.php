...
$IPBHTML .= <<<EOF
    <ul id='links'>
        ...
        <li><img src='{$this->registry->output->imageUrl}/link.gif' align='absmiddle' /> <a href='http://anonym.to/?http://external.ipslink.com/ipboard30/landing/?p=docs-ipb'>Документация</a></li>
        <li><img src='{$this->registry->output->imageUrl}/link.gif' align='absmiddle' /> <a href='http://ipbzona.ru'>IPBZona.ru</a></li>
    </ul>
EOF;
...
$IPBHTML .= <<<EOF
    <div class='message unspecific note'>
    	Если вам нужна помощь по работе с мастером установки, то обратитесь к <a href='http://anonym.to/?http://external.ipslink.com/ipboard30/landing/?p=installation-guide' target='_blank'><b>документации</b></a>.
    </div>
</div>
<br />
<div class='message unspecified'>
...
{
	$IPBHTML .= <<<EOF
						<li><a href='http://anonym.to/?http://external.ipslink.com/ipboard30/landing/?p=installation-guide' target='_blank'><b>Руководство по установке</b></a></li>
EOF;
}
